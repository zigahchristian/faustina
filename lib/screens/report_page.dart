        ...
        child: Column(
          children: [
            ...
            if (isLargeScreen)
              ...
              // Vertical layout for small screens - FULL WIDTH containers
              Column(
                crossAxisAlignment: CrossAxisAlignment.stretch, // This makes children expand to full width
                children: [
                  _buildFullWidthSummaryCard('Total Sales', _totalSales, Colors.green, Icons.trending_up, isSmallScreen),
                  SizedBox(height: 8),
                  _buildFullWidthSummaryCard('Total Expenses', _totalExpenses, Colors.red, Icons.trending_down, isSmallScreen),
                  SizedBox(height: 8),
...
,
  ...
  // NEW METHOD: Full width summary cards for small devices
  Widget _buildFullWidthSummaryCard(String title, double amount, Color color, IconData icon, bool isSmallScreen) {
    return Card(
      color: Color.fromRGBO(255, 255, 255, 1),
      child: Container(
